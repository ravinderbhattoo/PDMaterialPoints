...
# See also
- [`changetype(obj::T, f::Function, ntype::Int64) where T <: SuperShape`](@ref)
"""
...
"""
    changetype(obj::T, f::Function, ntype::Int64) where T <: SuperShape
...
```
"""
function changetype(obj::T, f::Function, ntype::Int64) where T <: SuperShape
    # x, v, y, vol, type
    function func(out)
        mask = vec(f(out))
        # change type
